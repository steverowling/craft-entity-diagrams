...
/**
 * Entity Diagrams en Translation
 *
 * Returns an array with the string to be translated (as passed to `Craft::t('entity-diagrams', '...')`) as
 ...
 */
return [
    'Entity Diagrams plugin loaded' => 'Entity Diagrams plugin loaded',
];
